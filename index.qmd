...
::: {.title data-id="title"}
Accessible and extensible design for statistical computing on distributions
:::
...
![](resources/projector-screen-outline.svg){.icon} [slides.mitchelloharawild.com/rsaa25](https://slides.mitchelloharawild.com/rsaa25)

![](resources/github.svg){.icon} [mitchelloharawild/talk-rsaa-distributional](https://github.com/mitchelloharawild/talk-rsaa-distributional)
